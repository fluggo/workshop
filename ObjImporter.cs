...
// Originally from http://wiki.unity3d.com/index.php?title=ObjImporter
...
public class ObjImporter {
	...
	public static Mesh ImportFile( string fileText ) {
		meshStruct newMesh = createMeshStruct( fileText );
		populateMeshStruct( fileText, ref newMesh );
	...
	private static void populateMeshStruct( string entireText, ref meshStruct mesh ) {
